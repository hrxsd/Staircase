...
class get_model(nn.Module):
    def __init__(self, num_classes):
        ...
        self.conv1 = nn.Conv1d(128, 128, 1)#inputchannel 128 outputchannel 128 kernelsize 1
        self.bn1 = nn.BatchNorm1d(128)
        self.drop1 = nn.Dropout(0.5)
        self.conv2 = nn.Conv1d(128, num_classes, 1)
        #self.fc1_for_norm = nn.Linear(num_classes,3)
...
class get_model_norm(nn.Module):
    def __init__(self,num_i = 11, num_h = 100, num_o = 3):
        super(get_model_norm,self).__init__()
...
class get_loss_norm(nn.Module):
    def __init__(self):
        super(get_loss_norm, self).__init__()
    def forward(self, pred, target):
        cel = nn.CrossEntropyLoss()
        return cel(pred, target)
